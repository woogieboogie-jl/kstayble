...
export const DEFAULT_IDENTITY: Identity = {
  ...
  verified: true,
  did: "did:omn:8f2d9c7b4e1f6a3c8d5e9f2a7b4c1d8e",
}

export const DEFAULT_CAPSULE: KPassCapsule = {
  id: "kpass:8f2d9c7b4e1f",
...
export const DEFAULT_EVENTS: ChainEvent[] = [
  {
    ...
    summary: "K-Pass Capsule issued for verified visitor (US passport DID)",
  },
  {
    id: "evt-2",
    type: "WalletLinked",
...
export const DEFAULT_NOTIFICATIONS: AppNotification[] = [
  { id: 1, type: "transaction", title: "Payment Successful", message: "You paid ₩135,727 to Olive Young", time: "2 hours ago", read: false, icon: "check", iconBg: "#e8ece8" },
